...
<div class="lesson_list row-fluid">
    <div class="box">
        <div class="box-title">
            <h3><?php echo $this->course_name . ': ' . (($this->arr_lesson) ? count($this->arr_lesson) : 0) . ' ' . translate('bài') ?></h3> 
        </div>
        <div class="box-content">
            <ul> 
                ...
                {
                    echo '<li><a href = "' . $this->get_controller_url() . 'dsp_single_lesson/' . $value['PK_LESSON'] . '">' . $value['C_NAME'] . '</a></li>';
                }
                ?>
            </ul> 
        </div>
