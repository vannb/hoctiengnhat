...
function moneyRandom() {
	...
	if (e.length > 0) {
		var t = parseFloat(e.html().replace("$", "").replace(",", ".")), n = Math
				.random() * 10, r = 1;
		n >= 5 && (r = -1);
...
function currentTime() {
	var e = $(".stats .icon-calendar").parent(), t = new Date, n = [ "January",
			"February", "March", "April", "May", "June", "July", "August",
			"September", "October", "November", "December" ], r = [ "Sunday",
			"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" ];
	e.find(".details .big").html(
			n[t.getMonth()] + " " + t.getDate() + ", " + t.getFullYear());
	e.find(".details span").last().html(
			r[t.getDay()] + ", " + t.getHours() + ":"
...
function showTooltip(e, t, n) {
	$(
			'<div id="tooltip" class="flot-tooltip tooltip"><div class="tooltip-arrow"></div>'
					+ n + "</div>").css({
		top : t - 43,
		left : e - 15
...
function randomFeed() {
	var e = $("#randomFeed"), t = new Array(
			...
			'<span class="label label-warning"><i class="icon-comment"></i></span> <a href="#">John Doe</a> commented on <a href="#">News #123</a>'), n = e
			.parents(".box").find(".box-title .actions .custom-checkbox")
			.hasClass("checkbox-active"), r = Math.floor(Math.random() * 4), i = t[r];
	if (n) {
		e.prepend("<tr><td>" + i + "</td></tr>").find("tr").first().hide();
		e.find("tr").first().fadeIn();
		e.find("tbody tr").length > 20
				&& e.find("tbody tr").last().fadeOut(400, function() {
					$(this).remove()
				})
	}
...
var onlineUserArray = [ 255, 455, 385, 759, 500, 284, 581, 684, 255, 455, 385,
		759, 500, 293, 585, 342, 684 ], balanceArray = [ 255, 455, 385, 759,
				...
				function() {
					...
					$(".table-user .icon .btn")
							.click(
									function(e) {
										e.preventDefault();
										var t = $(this), n = t.parents("tr"), r = n
												.find("td").eq(1).text(), i = n
												.find("td").eq(0).find("img")
												.attr("src"), s = r
												+ "@randomemailgenerated.com";
										$("#user-infos").text(r);
							...
							.submit(
									function(e) {
										...
										var t = $(this), n = new Array(
												...
												"Lorem ipsum in dolor Excepteur et non sunt elit non officia in qui deserunt cupidatat aliquip."), r = t
												.find("input[type=text]").val(), i = t
												.parents(".messages");
					...
					if ($("#flot-3").length > 0) {
						...
						function b() {
							...
							while (c.length < y) {
								var e = c.length > 0 ? c[c.length - 1] : 50, t = e
										+ Math.random() * 10 - 5;
								t < 0 && (t = 0);
								t > 100 && (t = 100);
								c.push(t)
					...
					if ($("#flot-audience").length > 0) {
						var c = [ [ 1262304e6, 1300 ], [ 12649824e5, 2200 ],
								[ 12674016e5, 3600 ], [ 127008e7, 5200 ],
								[ 1272672e6, 4500 ], [ 12753504e5, 3900 ],
								[ 12779424e5, 3600 ], [ 12806208e5, 4600 ],
								[ 12832992e5, 5300 ], [ 12858912e5, 7100 ],
								[ 12885696e5, 7800 ], [ 12912417e5, 8195 ] ];
						$.plot($("#flot-audience"), [ {
							label : "Visits",
							data : c,
							color : "#3a8ce5"
					...
					if ($("#flot-hdd").length > 0) {
						var c = [ [ 1364598e6, 10 ], [ 13646016e5, 12 ],
								[ 13646052e5, 14 ], [ 13646088e5, 14 ],
								[ 13646124e5, 10 ], [ 1364616e6, 16 ],
								[ 13646196e5, 18 ], [ 13646232e5, 15 ],
								[ 13646268e5, 16 ], [ 13646304e5, 18 ],
								[ 1364634e6, 20 ], [ 13646376e5, 22 ],
								[ 13646412e5, 24 ], [ 13646448e5, 25 ],
								[ 13646484e5, 27 ], [ 1364652e6, 31 ],
								[ 13646556e5, 33 ], [ 13646592e5, 36 ],
								[ 13646628e5, 37 ], [ 13646664e5, 38 ],
								[ 136467e7, 39 ], [ 13646736e5, 42 ],
								[ 13646772e5, 45 ], [ 13646808e5, 47 ],
								[ 13646844e5, 50 ] ];
						$.plot($("#flot-hdd"), [ {
							label : "HDD usage",
							data : c,
					...
					if ($("#flot-cpu").length > 0) {
						var c = [ [ 1364598e6, 50 ], [ 13646016e5, 45 ],
								[ 13646052e5, 50 ], [ 13646088e5, 40 ],
								[ 13646124e5, 60 ], [ 1364616e6, 50 ],
								[ 13646196e5, 40 ], [ 13646232e5, 30 ],
								[ 13646268e5, 35 ], [ 13646304e5, 55 ],
								[ 1364634e6, 40 ], [ 13646376e5, 30 ],
								[ 13646412e5, 45 ], [ 13646448e5, 55 ],
								[ 13646484e5, 65 ], [ 1364652e6, 40 ],
								[ 13646556e5, 45 ], [ 13646592e5, 50 ],
								[ 13646628e5, 55 ], [ 13646664e5, 60 ],
								[ 136467e7, 65 ], [ 13646736e5, 70 ],
								[ 13646772e5, 75 ], [ 13646808e5, 78 ],
								[ 13646844e5, 80 ] ];
						$.plot($("#flot-cpu"), [ {
							label : "CPU usage",
							data : c,
					...
					if ($(".calendar").length > 0
							&& !$(".calendar").parent().hasClass(
									"daterangepicker")) {
						var C = new Date, k = C.getDate(), L = C.getMonth(), A = C
								.getFullYear();
					...
					if ((location.pathname == "/flat/"
							|| location.pathname == "/flat" || location.pathname == "/flat/index.html")
					...
					if ($("#simg").length > 0) {
						function _(e) {
							return e.id ? "<img style='padding-right:10px;' src='img/demo/flags/"
									+ e.id.toLowerCase() + ".gif'/>" + e.text
									: e.text
						}
						$("#simg").select2({
							formatResult : _,
					...
					if ($("#map3").length > 0)
						var q = [ [ 47.398349200359256, .791015625 ],
								...
								[ 44.74673324024678, 7.6025390625 ] ], R = $(
								"#map3")
								.gmap3(
										{
											map : {
